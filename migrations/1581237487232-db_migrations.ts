...
export class dbMigrations1581237487232 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `cards` (`id` int NOT NULL AUTO_INCREMENT, `created_at` timestamp NOT NULL, `value` int NOT NULL, `card_type_id` int NOT NULL, `game_id` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `games` (`id` int NOT NULL AUTO_INCREMENT, `created_at` timestamp NOT NULL, `wallet_access_token` varchar(255) NOT NULL, `token` varchar(255) NOT NULL, `bet_amount` decimal NOT NULL, `user_id` int NOT NULL, `status_id` int NOT NULL, `finished_at` timestamp NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `access_tokens` (`id` int NOT NULL AUTO_INCREMENT, `created_at` timestamp NOT NULL, `token` varchar(255) NOT NULL, `expired_at` timestamp NOT NULL, `game_id` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
