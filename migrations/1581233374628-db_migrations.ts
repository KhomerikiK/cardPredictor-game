...
export class dbMigrations1581233374628 implements MigrationInterface {
    name = 'dbMigrations1581233374628'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `cards` (`id` int NOT NULL AUTO_INCREMENT, `created_at` timestamp NOT NULL, `value` int NOT NULL, `card_type_id` int NOT NULL, `game_id` int NOT NULL, UNIQUE INDEX `REL_010040e63b2b829e9303596463` (`card_type_id`), UNIQUE INDEX `REL_6afce8ac3bc3f66e8acbe87b43` (`game_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `games` (`id` int NOT NULL AUTO_INCREMENT, `created_at` timestamp NOT NULL, `wallet_access_token` varchar(255) NOT NULL, `token` varchar(255) NOT NULL, `bet_amount` decimal NOT NULL, `user_id` int NOT NULL, `status_id` int NOT NULL, `finished_at` timestamp NOT NULL, UNIQUE INDEX `REL_0708b7e9a570b2e1b8ba580730` (`status_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `access_tokens` (`id` int NOT NULL AUTO_INCREMENT, `created_at` timestamp NOT NULL, `token` varchar(255) NOT NULL, `expired_at` timestamp NOT NULL, `game_id` int NULL, UNIQUE INDEX `REL_aa83551f1ea55fc9ae8ab9cc7c` (`game_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
